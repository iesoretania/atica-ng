 ...
 */
class Version20170829232936 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE folder_permission (folder_id INT NOT NULL, element_id INT NOT NULL, permission INT NOT NULL, INDEX IDX_B07B22B162CB942 (folder_id), INDEX IDX_B07B22B1F1F2A24 (element_id), PRIMARY KEY(folder_id, element_id, permission)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
